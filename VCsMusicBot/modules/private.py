...
@Client.on_message(filters.private & filters.incoming & filters.command(['helpmusic']))
...
help_callback_filter = filters.create(lambda _, __, query: query.data.startswith('helpmusic+'))
